...
class MarketingPreferenceUpdateView(SuccessMessageMixin, UpdateView):
    ...
    # utilizam asta pu ca adaugat la clasa SuccessMessageMixin
    ...
    # metoda ce opereaza cu 'title' din 'base/forms.html'
    ...
    def get_object(self):
        user = self.request.user
        # definim obiectul clasei MarketingPreference in asa mod pu ca el e OneToOneField
